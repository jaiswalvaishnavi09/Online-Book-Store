...
public class signin_admin extends JFrame implements ActionListener {
   JTextField name_per;
   JTextField email_id;
   JTextField res_add;
   JTextField phone_no;
   JTextField id;
   JTextField shop_name;
   JButton signin;
   JButton back;
   JRadioButton male;
   JRadioButton female;
   ...
   public signin_admin() {
      ...
      ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("images/admin_6.jpg"));
      ...
      JLabel dob = new JLabel(" Shop Name : ");
      this.add(dob);
      dob.setBounds(150, 160, 200, 40);
      dob.setFont(f2);
      dob.setForeground(new Color(120, 120, 120));
      this.shop_name = new JTextField();
      this.add(this.shop_name);
      this.shop_name.setBounds(350, 160, 300, 30);
      this.shop_name.setFont(new Font("Arial", 0, 14));
      this.shop_name.setForeground(Color.black);
   ...
   public void actionPerformed(ActionEvent ae) {
      ...
      if (ae.getSource() == this.signin) {
         ...
         String identification = this.id.getText();
         String shopName = this.shop_name.getText();
         String gen = null;
         ...
         try {
            if (identification.equals("")) {
               ...
               Conn c = new Conn();
               String query = "insert into signup_admin values ('" + identification + "','" + pass + "','" + name + "','" + gen + "','" + shopName + "','" + address + "','" + email + "','" + phone + " ')";
               c.s.executeUpdate(query);
               this.setVisible(false);
               (new Admin_Page(identification)).setVisible(true);
            }
